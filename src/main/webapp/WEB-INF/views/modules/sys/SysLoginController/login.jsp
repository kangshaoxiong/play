...
<link href="${PURL}/static/H-ui/css/H-ui.login.css" rel="stylesheet" type="text/css" />
...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form class="form form-horizontal" action="${PURL}/manager/sys/index" method="post">
      <div class="row cl">
...
<div class="footer">Copyright NET.KANGSHAO.PLAY</div>
